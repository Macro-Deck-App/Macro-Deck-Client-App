  ...
  private handleInteraction(interaction: WidgetInteraction) {
    ...
    switch (interaction.widgetInteractionType) {
      ...
      case WidgetInteractionType.ButtonLongPressRelease:
        ...
        break;
      case WidgetInteractionType.WheelTurnedClockwise:
        method = "WHEEL_TURN_CLOCKWISE";
        break;
      case WidgetInteractionType.WheelTurnedCounterClockwise:
        method = "WHEEL_TURN_COUNTER_CLOCKWISE";
        break;
      case WidgetInteractionType.SpecialButtonPress:
        method = "SPECIAL_BUTTON_PRESS";
        break;
    }
    this.send({
      "Method": method,
